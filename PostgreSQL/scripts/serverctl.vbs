...
Select Case strAction
    Case "start"
         iRet = DoCmd("net start postgresql-x64-11")
    Case "stop"
         iRet = DoCmd("net stop postgresql-x64-11")
    Case "reload"
         iRet = DoCmd("""C:\Program Files\PostgreSQL\11\bin\pg_ctl.exe"" -D ""C:\Program Files\PostgreSQL\11\data"" reload")
    Case "restart"
	     iRet = DoCmd("net stop postgresql-x64-11")
		 If iRet = 0 Then
		     iRet = DoCmd("net start postgresql-x64-11")
